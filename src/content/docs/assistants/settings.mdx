...
## Agent Framework & Capabilities <Badge text="Advanced" variant="tip" size="small" />
...
<Aside type="note" title="Agent Framework Documentation">
For a complete reference on capability toggles, agent profiles, and the proactive scheduler, see the [Agent Framework guide](/assistants/agent-framework/).
</Aside>

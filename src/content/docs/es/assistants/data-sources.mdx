...
<Tabs syncKey="datasource">
  ...
  <TabItem label="Google Drive" icon="document">
    **Conecta Google Drive** para indexar tus documentos directamente desde la nube:
    - Selecciona archivos o carpetas individuales de tu Drive
    - Los cambios en Drive se sincronizan automáticamente
    - Compatible con Documentos de Google, Hojas de cálculo, PDFs subidos
    - Soporta Unidades Compartidas (de equipo)
    
    **Para conectar:**
    1. Haz clic en **Añadir fuente → Google Drive**
    2. Autoriza el acceso con tu cuenta de Google
    3. Selecciona los archivos o carpetas a indexar
    
    <Aside type="note" title="Unidades Compartidas">
    Las Unidades Compartidas son compatibles pero pueden requerir permisos de administrador de Google Workspace para acceder a todos los archivos.
    </Aside>
  </TabItem>
